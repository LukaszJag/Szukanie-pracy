...
angle=0,
contents={%
  \includegraphics[width=\paperwidth,height=\paperheight]{frog.jpg}
  }%
}
...
\simpleheader{headercolour}{Łukasz} {Jagnow}{}{white}
...
\backgroundcolor{g}[rgb]{0,0,0.7} % dark blue for left margin
...
{\footnotesize
I'm \textbf{computer science} student of last year. 
\newline
\newline
I write my diploma but I
don't have lessons at University.
\newline
\newline
I like work in team and alone I very flexible in this
area. Furthermore, I can work with client both in
English or Polish.}
\bigskip
...
\infobubble{\faAt}{cvgreen}{white}{lukasz.jagnow@gmial.com}
\infobubble{\faFacebook}{cvgreen}{white}{Łukasz Jagnow}
\infobubble{\faGithub}{cvgreen}{white}{LukaszJag}
